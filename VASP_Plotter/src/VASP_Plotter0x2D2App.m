classdef VASP_Plotter0x2D2App < handle
    %
    % Usage:
    %     app.VASP_Plotter0x2D2App
    ...
    properties (Constant)
        AppPathBase = {'/VASP_Plotter - 2'};
        AppClass = 'VASP_Plotter0x2D2App';
        Increment = 1;
        Decrement = 0;
        Version = '13a';
    end
    ...
    methods
        ...
        function obj = VASP_Plotter0x2D2App()
        ...
        function startApp(obj)
            ...
            mlock;
            VASP_Plotter0x2D2App.refcount(obj.Increment);
